...
const modules = function modules() {
  return {
    ...
    updateRelated: function(input) {
      return util.promiseResponse(util.constructRequestDetails(input, input.module + '/{id}/' + input.moduleRelated + '/' + input.idRelated, HTTP_METHODS.PUT, false));// No I18N
    },
